...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-background">
      <nav className="glass-card border-b border-white/10 shadow-lg">
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center space-x-8">
              ...
              <div className="flex space-x-2">
                <Link
                  href="/groceries"
                  className="flex items-center space-x-2 text-muted-foreground hover:text-foreground hover:bg-white/5 px-3 py-2 rounded-lg text-sm font-medium transition-all"
                >
